...
const componentsMap = {
  Supplier_Basic_info: CustomerBasic,
  "Supplier(S)_Detail": BranchsDetail,
...
// ✅ Icons for each tab
const tabIcons = {
  Supplier_Basic_info: <UserCircle size={13} />,
  "Supplier(S)_Detail": <Building2 size={13} />,
  "Intrested_Product(S)": <PackageSearch size={13} />,
  Follow_Up_Activity: <Activity size={13} />,
};

const Supplier = () => {
  const [activeTab, setActiveTab] = useState("Supplier_Basic_info");
